<!DOCTYPE html>
<!-- saved from url=(0047)emby-for-xbox-360.html -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Emby for Xbox 360 - Emby</title>
    ...
    <link rel="prev" title="Emby Server for NAS" href="nas-server.html">
    <link rel="next" title="Emby Server for Linux" href="linux-server.html">
...
<body class="single single-us_portfolio postid-5260 l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby for Xbox 360</h1>
                        <p>And other Media Center Extenders</p>								<div class="w-pagehead-nav">
                            <div class="w-pagehead-nav-h">
                                <a class="w-pagehead-nav-item type_prev" href="linux-server.html" title="Emby Server for Linux"><i class="mdfi_navigation_chevron_left"></i></a>
                                <a class="w-pagehead-nav-item type_next" href="nas-server.html" title="Emby Server for NAS"><i class="mdfi_navigation_chevron_right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- /FOOTER -->
    <a class="w-toplink" href="emby-for-xbox-360.html#"><i class="mdfi_hardware_keyboard_arrow_up"></i></a>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-02 20:07:18 -->
    <!-- Compression = gzip -->
</body>
</html>
