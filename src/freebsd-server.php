<!DOCTYPE html>
<!-- saved from url=(0044)https://emby.media/downloads/freebsd-server/ -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Emby Server for FreeBSD - Emby</title>
    <meta name="description" content="Emby Server for FreeBSD - Organize and stream your personal videos, music, photos and Live TV to any device.">
    ...
    <meta property="article:published_time" content="2014-06-27T16:07:52.711" />
    <meta property="article:modified_time" content="2016-06-27T16:07:52.711" />
    ...
    <link rel="prev" title="Emby for Samsung Smart TV" href="emby-for-samsung-smart-tv.html">
    <link rel="next" title="Emby for Kodi" href="emby-for-kodi.html">
...
<body class="single single-us_portfolio postid-5084 l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby Server for FreeBSD</h1>
                        <div class="w-pagehead-nav">
                            <div class="w-pagehead-nav-h">
                                <a class="w-pagehead-nav-item type_prev" href="emby-for-kodi.html" title="Emby for Kodi"><i class="mdfi_navigation_chevron_left"></i></a>
                                <a class="w-pagehead-nav-item type_next" href="emby-for-samsung-smart-tv.html" title="Emby for Samsung Smart TV"><i class="mdfi_navigation_chevron_right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <div style="margin:0 auto;max-width:450px;">
                                        <h2>Install</h2>
                                        <p><code>pkg install emby-server</code></p>
                                        <h2>Configure FFMpeg</h2>
                                        <p>
                                            <code>
                                                # Update FreeBSD ports tree<br>
                                                portsnap fetch update
                                            </code>
                                        </p><code>
                                            <p>
                                                # Remove default FFMpeg package<br>
                                                pkg delete -f ffmpeg
                                            </p>
                                        </code><p>
                                            <code>
                                                ...
                                                # enable the SMB option<br>
                                                # enable the ass subtitles option<br>
                                                # enable the opus subtitles option<br>
                                                # enable the x265 subtitles option<br>
                                                make install clean
                                            </code>
                                        </p>
                                        <h2>Run</h2>
                                        <p><code>service emby-server start</code></p>
                                        <p>
                                            To enable Emby service (will automatically run at boot):<br>
                                            <code>sysrc emby_server_enable="YES"</code>
                                        </p>
                        ...
                        <div class="one-third">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h4>Resources</h4>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/forum/122-freebsd" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-users"></i><span>Community</span><span class="ripple-container"></span></a></span>
                                    <div>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-03 00:13:09 -->
    <!-- Compression = gzip -->
</body>
</html>