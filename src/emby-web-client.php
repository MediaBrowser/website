<!DOCTYPE html>
<!-- saved from url=(0045)https://emby.media/downloads/emby-web-client/ -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Emby Web Client - Emby</title>
    <meta name="description" content="Emby Web App - Organize and stream your personal videos, music, photos and Live TV to any device.">
    {SOCIALNETWORKS}
    ...
    <link rel="stylesheet" id="us-font-1-css" href="resources/css" type="text/css" media="all">
    ...
    <link rel="prev" title="Emby for Android TV" href="emby-for-android-tv.html">
...
<body class="single single-us_portfolio postid-5279 l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby Web Client</h1>
                        <p>Your portable media manager</p>								<div class="w-pagehead-nav">
                            <div class="w-pagehead-nav-h">
                                <a class="w-pagehead-nav-item type_next" href="emby-for-android-tv.html" title="Emby for Android TV"><i class="mdfi_navigation_chevron_right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="l-submain-h g-html i-cf">
                    <div class="g-cols wpb_row offset_wide">
                        ...
                        <div class="two-thirds">
                            <div class="w-slider">
                                <style></style><div class="fotorama--hidden"></div><div class="fotorama fotorama1451854225262" id="slider_872392" data-auto="false" data-shadows="false" data-glimpse="0" data-margin="0" data-loop="true" data-swipe="true" data-width="100%" data-autoplay="true" data-arrows="always" data-nav="none" data-transition="slide" data-ratio="1613/851"><div class="fotorama__wrap fotorama__wrap--css3 fotorama__wrap--slide fotorama__wrap--no-shadows fotorama__wrap--no-controls" style="width: 100%; min-width: 0px; max-width: 100%;"><div class="fotorama__stage fotorama__pointer" style="width: 737px; height: 389px;"><div class="fotorama__stage__shaft" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px); width: 737px; margin-left: 0px;"><div class="fotorama__stage__frame fotorama__loaded fotorama__loaded--img" style="left: -737px;"><img src="resources/web7.png" class="fotorama__img" style="width: 220px; height: 389px; left: 258px; top: 0px;"></div><div class="fotorama__stage__frame fotorama__loaded fotorama__loaded--img fotorama__active" style="left: 0px;"><img src="resources/web8.png" class="fotorama__img" style="width: 220px; height: 389px; left: 258px; top: 0px;"></div><div class="fotorama__stage__frame fotorama__loaded fotorama__loaded--img" style="left: 737px;"><img src="resources/web9.png" class="fotorama__img" style="width: 220px; height: 389px; left: 258px; top: 0px;"></div></div><div class="fotorama__arr fotorama__arr--prev" tabindex="0" role="button"></div><div class="fotorama__arr fotorama__arr--next" tabindex="0" role="button"></div><div class="fotorama__video-close"></div></div></div></div>
                            </div>
                        </div><div class="one-third">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">

                                    <h4>Your&nbsp;Media, Anytime, Anywhere</h4>
                                    <p>
                            ...
                            </div><span class="wpb_button align_left">
                                <a href="http://app.emby.media" target="_blank" class="g-btn color_primary type_raised" onclick="ga('send', 'event', 'Download Links', 'Downloaded', 'WebApp');"><i class="fa fa-external-link-square"></i><span>Sign In</span><span class="ripple-container"></span></a>
                            </span>
                            <div class="g-cols wpb_row offset_wide">
                                <div class="full-width">
                                    <div class="wpb_text_column ">
                                        <div class="wpb_wrapper">
                                            ...
                                            <h4 style="margin-top:1em;">Also Included with Emby Server</h4>
                                            <p>
                                                The Emby Web Client is also bundled with Emby Server, and can be accessed using http://{ipAddress}:8096.
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-03 15:50:57 -->
    <!-- Compression = gzip -->
</body>
</html>
