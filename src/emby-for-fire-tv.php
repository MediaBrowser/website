<!DOCTYPE html>
<!-- saved from url=(0046)https://emby.media/downloads/emby-for-fire-tv/ -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Emby for Amazon Fire TV - Emby</title>
    ...
    <link rel="prev" title="Emby for iOS" href="emby-for-ios.html">
    <link rel="next" title="Emby for Android" href="emby-for-android-mobile.html">
...
<body class="single single-us_portfolio postid-5252 l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
        ...
        <div class="l-main">
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby for Amazon Fire TV</h1>
                        <div class="w-pagehead-nav">
                            <div class="w-pagehead-nav-h">
                                <a class="w-pagehead-nav-item type_prev" href="emby-for-android-mobile.html" title="Emby for Android"><i class="mdfi_navigation_chevron_left"></i></a>
                                <a class="w-pagehead-nav-item type_next" href="emby-for-ios.html" title="Emby for iOS"><i class="mdfi_navigation_chevron_right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="l-submain wpb_row">
                <div class="l-submain-h g-html i-cf">
                        ...
                        <div class="two-thirds">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <p>
                                        <img src="resources/5537f5f940bcb_firehome21.png">
                                    </p>
                        ...
                        <div class="one-third">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h3>Download</h3>
                                    <p>Emby for Fire TV is available in the Amazon App Store.</p>
                                    <div>
                                        <a href="http://www.amazon.com/Emby-for-Fire-TV/dp/B00VVJKTW8" target="_blank"><img class="alignnone size-medium wp-image-5449" src="resources/amazonapp.png" alt="playsstore" style="max-height: 54px;"></a>
                                    </div>


                                    <br />
                                    <div>
                                        <span class="wpb_button align_left"><a href="https://github.com/MediaBrowser/Wiki/wiki/Fire%20TV" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-info-circle"></i><span>Wiki</span><span class="ripple-container"></span></a></span>
                                    </div>
                                    <div>
                    ...
                    <!-- Row Backgrounds -->
                    <div class="upb_no_bg" data-fadeout="" data-fadeout-percentage="30" data-parallax-content="" data-parallax-content-sense="30" data-row-effect-mobile-disable="true" data-img-parallax-mobile-disable="true" data-rtl="false" data-custom-vc-row="" data-vc="4.5.2" data-theme-support=""></div><div class="g-cols wpb_row offset_wide">
                        <div class="full-width">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">

                                    <h2 style="margin-top:1em;">Fast, easy browsing</h2>
                                    <p>For those times you do want to peruse your library, Emby for Android TV makes it a breeze. Providing several ways to traverse your content and rich search capability, you’ll find what you’re looking for in no time.</p>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-02 20:01:22 -->
    <!-- Compression = gzip -->
</body>
</html>
