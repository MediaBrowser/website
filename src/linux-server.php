...
<head itemscope itemtype="http://schema.org/Article">
    ...
    <meta charset="UTF-8">
    <title>Emby Server for Mac - Emby</title>
    <meta name="description" content="Emby Server for Apple Mac OSX - Organize and stream your personal videos, music, photos and Live TV to any device.">
    {SOCIALNETWORKS}
                        ...
                        <div class="two-thirds">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <div>
                                        <h2>Installation - x64</h2>

                                        <div style="margin:1em 0;">
                                            <label>
                                                <div>Select operating system:</div>
                                                <select onchange="onPlatformChange(this.value);" style="height:auto;">
                                        ...
                                        <div class="installPlatform hide archlinux">
                                        ...
                                        <div class="installPlatform hide centos">

                                            <div><b>Download</b></div>
                                            <ul style="margin-bottom:1em;">
                                                <li><a class="lnkPackageDownload" data-filename="emby-server-rpm_{version}_x86_64.rpm" href="https://github.com/MediaBrowser/Emby/releases/download/3.2.50.0/emby-server-rpm_3.2.50.0_x86_64.rpm">x64</a></li>
                                            </ul>

                                            <div><b>Install</b></div>
                                            <div><code style="white-space:nowrap;" class="lnkPackageInnerHtml" data-filename="emby-server-rpm_{version}_x86_64.rpm">yum install {filename}</code></div>

                                        </div>

                                        <div class="installPlatform hide fedora">
                                            ...
                                            <div><b>Install</b></div>
                                            <div><code style="white-space:nowrap;" class="lnkPackageInnerHtml" data-filename="emby-server-rpm_{version}_x86_64.rpm">dnf install {filename}</code></div>
                                        </div>

                                        <div class="installPlatform hide opensuse">
                                            ...
                                            <div><b>Install</b></div>
                                            <div><code style="white-space:nowrap;" class="lnkPackageInnerHtml" data-filename="emby-server-rpm_{version}_x86_64.rpm">zypper install {filename}</code></div>

                                        </div>

                                        <div class="installPlatform ubuntu">

                                            <div><b>Download</b></div>
                                            <ul style="margin-bottom:1em;">
                                                <li><a class="lnkPackageDownload" data-filename="emby-server-deb_{version}_amd64.deb" href="https://github.com/MediaBrowser/Emby/releases/download/3.2.50.0/emby-server-deb_3.2.50.0_amd64.deb">x64</a></li>
                                            </ul>

                                            <div><b>Install</b></div>
                                            <div><code style="white-space:nowrap;" class="lnkPackageInnerHtml" data-filename="emby-server-deb_{version}_amd64.deb">dpkg -i {filename}</code></div>

                                        </div>

                                        <div class="installPlatform hide debian">
                                        ...
                                        <div class="installPlatform hide linuxmint">
                                        ...
                                        <br />
                                        <h2>Installation - ARM</h2>
                                        <p>Follow the instructions for your distro on the <a target="_blank" href="https://software.opensuse.org/download.html?project=home%3Aemby&package=emby-server">Emby Open Build Service</a>.</p>
                                        <div><strong>Run Setup Wizard</strong></div>
                                        <p>Visit http://localhost:8096</p>
                                    </div>
                                </div>
                            ...
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h4>Resources</h4>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-users"></i><span>Community</span><span class="ripple-container"></span></a></span>
                                    <div>
