<!DOCTYPE html>
<!-- saved from url=(0040)mac-server.html -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Emby Server for Windows</title>
    <meta name="description" content="Emby Server for Windows - Organize and stream your personal videos, music, photos and Live TV to any device.">
    ...
    <link rel="prev" title="Emby for Kodi" href="emby-for-kodi.html">
    <link rel="next" title="Emby Theater" href="emby-theater.html">
    ...
    <script>
        ...
        function showBetaMessage() {
            ...
            alert('Thank you for choosing to participate in testing Emby Server Beta releases. Please note we do not recommend switching the same Emby Server installation between release channels. If you decide to switch to Stable, we recommend a fresh installation.');
        }
            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby Server for Windows</h1>
                        <div class="w-pagehead-nav">
                            <div class="w-pagehead-nav-h">
                                <a class="w-pagehead-nav-item type_prev" href="emby-theater.html" title="Emby Theater"><i class="mdfi_navigation_chevron_left"></i></a>
                                <a class="w-pagehead-nav-item type_next" href="emby-for-kodi.html" title="Emby for Kodi"><i class="mdfi_navigation_chevron_right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="g-cols wpb_row offset_wide">
                        <div class="two-thirds">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    <div style="margin:0 auto;max-width:450px;">
                                        ...
                                        <p>
                                            <div>
                                                <a href="http://embydata.com/downloads/server/release5/setup.exe" onclick="ga('send', 'event', 'Download Links', 'Downloaded', 'WindowsRelease');" class="g-btn color_primary type_raised"><i class="fa fa-download"></i><span>Download Emby Server</span><span class="ripple-container"></span></a>
                                            </div>
                                            <div style="font-size:90%;">
                                                * Supports Windows 7 SP1 or newer version of Windows. If running Windows 7 please make sure Windows Updates are fully up to date.
                                            </div>
                                            <br /><a href="http://embydata.com/downloads/server/beta9/setup.exe" onclick="showBetaMessage(); ga('send', 'event', 'Download Links', 'Downloaded', 'WindowsBeta');">Beta Channel</a>
                                        </p>
                                        <p style="margin-bottom:0;">
                                            <strong>Complete the Server Setup Wizard</strong><br />
                                            The server will attempt to launch the web-based setup wizard in your default browser. If this does not happen, simply open your browser and visit http://localhost:8096
                                        </p>
                                        <h2 style="margin-top:0;margin-bottom:0em;">Portable Installation</h2>
                                        <p>
                                            <br />- Download and unzip one of the following zip files depending on system architecture:
                                            <br /><a class="lnkPackageDownload" data-filename="embyserver-windows-x64-{version}.7z" href="https://github.com/MediaBrowser/Emby/releases/download/3.2.50.0/embyserver-windows-x64-3.2.50.0.7z">Windows x64</a>
                                            <br /><a class="lnkPackageDownload" data-filename="embyserver-windows-x86-{version}.7z" href="https://github.com/MediaBrowser/Emby/releases/download/3.2.50.0/embyserver-windows-x86-3.2.50.0.7z">Windows x86</a>
                                            <br />- Run EmbyServer.exe from within the System sub-folder
                                            <br />- Run the Emby Server setup wizard by visiting http://localhost:8096
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    <h4>Resources</h4>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/forum/53-windowsgeneral" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-users"></i><span>Community</span><span class="ripple-container"></span></a></span>
                                    <div>
                                        <span class="wpb_button align_left"><a href="https://github.com/MediaBrowser/Wiki/wiki" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-book"></i><span>Wiki</span><span class="ripple-container"></span></a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
