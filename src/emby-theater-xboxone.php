<!DOCTYPE html>
<!-- saved from url=(0042)emby-theater.html -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Emby Theater for Xbox One- Emby</title>
    <meta name="description" content="Emby for Xbox One - Organize and stream your personal videos, music, photos and Live TV to any device.">
    {SOCIALNETWORKS}
    ...
    <link rel="prev" title="Emby Server for Mac" href="mac-server.html">
    <link rel="next" title="Emby Server for NAS" href="nas-server.html">
...
<body class="single single-us_portfolio postid-5262 l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby Theater</h1>
                        <p>for Windows 10 Universal.</p>								<div class="w-pagehead-nav">
                            <div class="w-pagehead-nav-h">
                                <a class="w-pagehead-nav-item type_prev" href="nas-server.html" title="Emby Server for NAS"><i class="mdfi_navigation_chevron_left"></i></a>
                                <a class="w-pagehead-nav-item type_next" href="mac-server.html" title="Emby Server for Mac"><i class="mdfi_navigation_chevron_right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="two-thirds">
                            ...
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h2>Download Now</h2>
                                    <p>
                                        Install in the <a href="https://www.microsoft.com/en-us/store/p/emby-theater/9nblggh4t70l" target="_blank">Microsoft Windows Store</a>.
                                    </p>
                                    <p style="margin-top: 2em;">
                                        Emby Theater is free to browse your media, while playback requires <a href="premiere.html">Emby Premiere</a>.
                                    </p>

                                    <h2>Also Runs in Your Browser</h2>
                                    <p>
                                        Just open your web browser and visit <a href="http://tv.emby.media" target="_blank">tv.emby.media</a>.
                                    </p>
                                    <p>Turn Emby Theater into an app by adding it to your home screen. Emby Theater supports your Xbox One game controller for easy navigation.</p>
                                    <p style="margin-top: 2em;">
                                        Emby Theater is free to browse your media, while playback requires <a href="premiere.html">Emby Premiere</a>.
                                    </p>
                                </div>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-03 10:25:28 -->
    <!-- Compression = gzip -->
</body>
</html>
