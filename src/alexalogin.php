                        ...
                        <div class="full-width">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <p style="text-align: center; margin-top: 2em">The Emby Alexa skill talks to your server via an account linked through Emby Connect.  To learn how to setup one of your Emby users with Connect, please see <a href="https://github.com/MediaBrowser/Wiki/wiki/Emby%20Connect#guide-for-administrators">Emby Connect for Administrators</a>.  Once you have configured the user you wish Alexa to use, then enter those Emby Connect credentials below.</p>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div style="text-align: center;">
                                            ...
                                            <form id="selectServerForm" style="margin: 0 auto; width: 100%; max-width: 400px; display: none;">
                                                ...
                                                <label style="text-align: left; display: block;">
                                                    ...
                                                    <div>Server to control with Alexa:</div>
                                                ...
                                                <p>
                                                    <button class="g-btn color_primary type_raised size_big" type="submit" style="display: block; margin-top: 30px; width: 100%;">Link to Alexa<span class="ripple-container"></span></button><br>
                                                </p>
                                            </form>
