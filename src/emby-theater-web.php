            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby Theater</h1>
                        <p>for Chrome, Opera, Firefox, and Microsoft Edge.</p>								<div class="w-pagehead-nav">
                        ...
                        <div class="one-third">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h2>A Modern Web App</h2>
                                    <p>Emby Theater runs right in your browser with nothing to install. Try it now at <a href="http://tv.emby.media" target="_blank">tv.emby.media</a></p>
