...
<body class="page page-id-5049 page-template-default l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
                        ...
                        <div class="full-width">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <p style="text-align: center; margin-top: 2em">Emby for Google Home talks to your server via an account linked through Emby Connect.  To learn how to setup one of your Emby users with Connect, please see <a href="https://github.com/MediaBrowser/Wiki/wiki/Emby%20Connect#guide-for-administrators">Emby Connect for Administrators</a>.  Once you have configured the user you wish Google Home to use, then enter those Emby Connect credentials below.</p>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="widget widget_text">
                                    <div class="textwidget">
                                        <div style="text-align: center;">
                                            <form id="confirmForm" style="margin: 0 auto; width: 100%; max-width: 400px;">
                                                <label style="text-align: left; display: block;margin-bottom:2em;">

                                                    <div>Emby Connect username or email:</div>
                                                    <input id="username" style="width: 100%;" type="text" class="not-empty" required>
                                                ...
                                                <label style="text-align: left; display: block; margin-bottom: 2em;">
                                                    ...
                                                    <div>Password:</div>
                                                    <input id="pw" style="width: 100%;" type="password" class="not-empty" required>

                                                </label>
                                                <p id="msg" style="display:none;color:red;"></p>
                                                <p>
                                                    <button class="g-btn color_primary type_raised size_big" type="submit" style="display: block; margin-top: 30px; width: 100%;">Sign In<span class="ripple-container"></span></button><br>
                                                </p>
                                            </form>
                                            <form id="selectServerForm" style="margin: 0 auto; width: 100%; max-width: 400px; display: none;">

                                                <label style="text-align: left; display: block;">

                                                    <div>Server to control with Google Home:</div>
                                                    <select style="width: 100%;" id="selectServer" required></select>

                                                </label>
                                                <div style="color:#444;margin-top:.5em;margin-bottom:2em;">Server not listed? Set your server up with Emby Connect.</div>

                                                <p>
                                                    <button class="g-btn color_primary type_raised size_big" type="submit" style="display: block; margin-top: 30px; width: 100%;">Link to Google Home<span class="ripple-container"></span></button><br>
                                                </p>
                                            </form>
                                            <script src="resources/jquery-2.1.3.min.js"></script><br>
                                            <script type="text/javascript" src="resources/alexalogin.js"></script>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-03 05:25:33 -->
    <!-- Compression = gzip -->
</body>
</html>