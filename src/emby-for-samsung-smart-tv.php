<!DOCTYPE html>
<!-- saved from url=(0055)https://emby.media/downloads/emby-for-samsung-smart-tv/ -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Emby for Samsung Smart TV - Emby</title>
    ...
    <link rel="next" title="Emby Server for FreeBSD" href="freebsd-server.html">
...
<body class="single single-us_portfolio postid-5268 l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby for Samsung Smart TV</h1>
                        <div class="w-pagehead-nav">
                            <div class="w-pagehead-nav-h">
                                <a class="w-pagehead-nav-item type_prev" href="freebsd-server.html" title="Emby Server for FreeBSD"><i class="mdfi_navigation_chevron_left"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="l-submain-h g-html i-cf">
                    <div class="g-cols wpb_row offset_wide">
                        ...
                        <div class="one-third">
                            ...
                            <h2 style="margin-top: 0; padding-top: 0;">Download</h2>
                            <div>
                                <p>Emby is available for download and installation on your Samsung Smart TV.</p>
                                <div style="margin-top: 0; padding-top: 0; font-weight: bold;">2013 - 2017 Models</div>
                                <p>Users in the USA, UK, and Ireland can install Emby in Samsung App Store.</p>
                                <div>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/topic/9869-samsung-smart-tv-app-install-instructions/?p=277344" target="_blank" class="g-btn color_primary type_raised"><span>2014 H-Series</span><span class="ripple-container"></span></a></span>
                                </div>
                                <div>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/topic/9869-samsung-smart-tv-app-install-instructions/?p=277345" target="_blank" class="g-btn color_primary type_raised"><span>2013 F-Series</span><span class="ripple-container"></span></a></span>
                                </div>
                                <div>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/topic/9869-samsung-smart-tv-app-install-instructions/?p=277346" target="_blank" class="g-btn color_primary type_raised"><span>2012 E-Series</span><span class="ripple-container"></span></a></span>
                                </div>
                                <div>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/topic/9869-samsung-smart-tv-app-install-instructions/?p=277348" target="_blank" class="g-btn color_primary type_raised"><span>2011 D-Series</span><span class="ripple-container"></span></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="full-width">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <p>For those times you do want to peruse your library, Emby Theater makes it a breeze. Providing several ways to traverse your content and rich search capability, you’ll find what you’re looking for in no time.</p>
                                    <div id="gallery_408676" class="w-gallery columns_2 type_masonry with_indents animate_revealgrid">
                                        <div class="w-gallery-tnails" style="position: relative; height: 711px;">
                                            <a class="w-gallery-tnail order_1 animate_reveal" href="resources/theater14.png" title="atv1" style="position: absolute; left: 0px; top: 0px;"><img width="600" height="371" src="resources/theater14.png" class="w-gallery-tnail-img" alt="atv1"><span class="w-gallery-tnail-title"></span></a>
                                            <a class="w-gallery-tnail order_2 animate_reveal" href="resources/2.png" title="atv2" style="position: absolute; left: 572px; top: 0px;"><img width="600" height="372" src="resources/2.png" class="w-gallery-tnail-img" alt="atv2"><span class="w-gallery-tnail-title"></span></a>
                                            <a class="w-gallery-tnail order_3 animate_reveal" href="resources/5.png" title="atv3" style="position: absolute; left: 0px; top: 355px;"><img width="600" height="372" src="resources/5.png" class="w-gallery-tnail-img" alt="atv3"><span class="w-gallery-tnail-title"></span></a>
                                            <a class="w-gallery-tnail order_4 animate_reveal" href="resources/6.png" title="atv4" style="position: absolute; left: 572px; top: 356px;"><img width="600" height="371" src="resources/6.png" class="w-gallery-tnail-img" alt="atv4"><span class="w-gallery-tnail-title"></span></a>
                                        </div>
                                    </div>

                                    <h2 style="margin-top: 1em;">Rediscover your content</h2>
                                    <p>Emby Theater also uses the power of the server to help you find movies to watch for the first time or over and over.</p>
                                    <p>
                                    ...
                                    <p>
                                        <img src="resources/theaterlivetv3.png">
                                    </p>
                                    <h2 style="margin-top: 1em;">Easily Schedule DVR Recordings</h2>
                                    <p>Starting a recording requires only a single button click, whether it's ahead of time or while watching the live program.</p>
                                    <p>
                                        <img src="resources/theaterlivetv4.png">
                                    </p>
                                    <h2 style="margin-top: 1em;">Fast Access to Your Latest Recordings</h2>
                                    <p>Recordings are organized in a beautiful, intuitive display to help you get the most out of your Emby DVR experience.</p>
                                    <p>
                                        <img src="resources/theaterlivetv2.png">
                                    </p>
                                    ...
                                    <p>
                                        <img src="resources/theater12.png">
                                    </p>
                                    <h2 style="margin-top: 1em;">The next of a new generation</h2>
                                    <p>The new Emby Theater app is another in our new generation of more intelligent apps for all your devices. Designed more like the web app, Emby Theater continues our commitment to make Emby the absolute best solution for your personal media collection.</p>
                                    <p>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-03 10:56:03 -->
    <!-- Compression = gzip -->
</body>
</html>
