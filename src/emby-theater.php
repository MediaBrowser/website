            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Emby Theater</h1>
                        <p>for Windows 7, 8, 10 and Vista</p>								<div class="w-pagehead-nav">
                        ...
                        <div class="one-third">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h2>Download</h2>
                                    <p>Emby Theater is available for Windows 7, 8, 10 and Vista.</p>
                                    <span class="wpb_button align_left"><a href="http://embydata.com/downloads/theater/release4/setup.exe" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-download"></i><span>Download</span><span class="ripple-container"></span></a></span>

                                    <p style="margin-top:2em;">Emby Theater is free to browse your media, while playback requires <a href="premiere.html">Emby Premiere</a>.</p>
