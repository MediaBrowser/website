<!DOCTYPE html>
<!-- saved from url=(0027)https://emby.media/support/ -->
<html prefix="og: http://ogp.me/ns#" class="no-touch" lang="en-US">
<head itemscope itemtype="http://schema.org/Article">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <title>Support - Emby</title>
    <meta name="description" content="Emby Support, Wiki and Social Media, Twitter, Facebook, Google+, Github, and more.">
    {SOCIALNETWORKS}
...
<body class="page page-id-4975 page-template-default l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
                ...
                <div class="l-subheader-h i-widgets i-cf">
                    ...
                    <nav class="w-nav layout_hor animation_mdesign height_auto type_desktop">
                        ...
                        <ul class="w-nav-list level_1  hover_none" style="display: block;">
                            ...
                            <li id="menu-item-5005" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-4975 current_page_item w-nav-item level_1 menu-item-5005"><a class="w-nav-anchor level_1" href="support.html"><span class="w-nav-title">SUPPORT</span><span class="w-nav-arrow"></span><span class="ripple-container"></span></a></li>
                        </ul>
                    </nav><!-- /NAV -->
                    ...
                    <div class="g-cols wpb_row offset_wide">
                        <div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="https://emby.media/community" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color:#333333;background:#ffffff;font-size:100px;display:inline-block;">
                                                    <i class="Defaults-comments"></i>
                                                </div>
                                            </div>
                                        </div><div class="aio-icon-header"><h3 class="aio-icon-title" style="">Community</h3></div> <!-- header --><div class="aio-icon-description" style="">Communicate directly with Emby&nbsp;developers and other knowledgeable users.</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div><div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="https://github.com/MediaBrowser/Wiki/wiki" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color:#333333;background:#ffffff;font-size:100px;display:inline-block;">
                                        ...
                                        </div><div class="aio-icon-header"><h3 class="aio-icon-title" style="">Wiki</h3></div> <!-- header --><div class="aio-icon-description" style="">Read installation guides, as well as tips and tricks for organizing your media.</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div><div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="https://www.facebook.com/embyapp" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color:#333333;background:#ffffff;font-size:100px;display:inline-block;">
                                        ...
                                        </div><div class="aio-icon-header"><h3 class="aio-icon-title" style="">Facebook</h3></div> <!-- header --><div class="aio-icon-description" style="">Like us on Facebook to see the latest feature announcements and more in your news feed.</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div><div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="http://www.twitter.com/embyapp" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color:#333333;background:#ffffff;font-size:100px;display:inline-block;">
                                        ...
                                        </div><div class="aio-icon-header"><h3 class="aio-icon-title" style="">Twitter</h3></div> <!-- header --><div class="aio-icon-description" style="">Connect with us via Twitter for the latest feature announcements and more.</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div>
                        ...
                        <div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="http://github.com/mediabrowser" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color:#333333;background:#ffffff;font-size:100px;display:inline-block;">
                                                    <i class="Defaults-github"></i>
                                                </div>
                                            </div>
                                        </div><div class="aio-icon-header"><h3 class="aio-icon-title" style="">Github</h3></div> <!-- header --><div class="aio-icon-description" style="">Fork us on Github!</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div>
                        <div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="https://plus.google.com/u/0/104622186938779417813/posts" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color: #333333; background: #ffffff; font-size: 100px; display: inline-block;">
                                        ...
                                        <div class="aio-icon-header">
                                            <h3 class="aio-icon-title" style="">Google Plus</h3>
                                        </div> <!-- header -->
                                        <div class="aio-icon-description" style="">Follow us on Google Plus&nbsp;to keep up with the latest Emby news.</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div>
                        ...
                        <div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="https://www.pinterest.com/emby0240/emby-news/" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color: #333333; background: #ffffff; font-size: 100px; display: inline-block;">
                                        ...
                                        <div class="aio-icon-header">
                                            <h3 class="aio-icon-title" style="">Pinterest</h3>
                                        </div> <!-- header -->
                                        <div class="aio-icon-description" style="">Follow us on Pinterest to keep up with the latest Emby news.</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div>
                        ...
                        <div class="one-quarter">
                            <div class="aio-icon-component   style_2">
                                <a class="aio-icon-box-link" href="http://embyapp.tumblr.com/" target=" _blank">
                                    <div class="aio-icon-box top-icon" style="">
                                        <div class="aio-icon-top">
                                            <div class="ult-just-icon-wrapper ">
                                                <div class="aio-icon circle  animated fadeIn delay-03" data-animation="fadeIn" data-animation-delay="03" style="color: #333333; background: #ffffff; font-size: 100px; display: inline-block;">
                                        ...
                                        <div class="aio-icon-header">
                                            <h3 class="aio-icon-title" style="">Tumblr</h3>
                                        </div> <!-- header -->
                                        <div class="aio-icon-description" style="">Follow us on Tumblr to keep up with the latest Emby news.</div> <!-- description -->
                                    </div> <!-- aio-icon-box -->
                                </a>
                            </div> <!-- aio-icon-component -->
                        </div>
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-03 06:55:54 -->
    <!-- Compression = gzip -->
</body>
</html>