                    ...
                    <div class="g-cols wpb_row offset_wide">
                        <div class="two-thirds">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    <div style="margin: 0 auto; max-width: 450px;">
                                        ...
                                        <div>
                                            <strong>Install Emby Server</strong>
                                        </div>
                                        <p>
                                            <code style="white-space:nowrap;">docker run -it --rm -v /usr/local/bin:/target emby/embyserver_netcore instl</code>
                                            <br /><br />Or for for armhf/armv7 (Rpi 2/3):
                                            <br /><code style="white-space:nowrap;">docker run -it --rm -v /usr/local/bin:/target emby/embyserver:armv7 instl</code>
                                            <br /><br />Or for for aarch64/armv8:
                                            <br /><code style="white-space:nowrap;">docker run -it --rm -v /usr/local/bin:/target emby/embyserver:aarch64 instl</code>
                                        </p>
                                        <div>
                                            <strong>Run Emby Server</strong>
                                        </div>
                                        <p>
                                            <code>/usr/local/bin/emby-server</code>
                                        </p>
                                        <div>On first run answer any on-screen prompts.</div>
                                        <div>
                            ...
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    <h4>Resources</h4>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/topic/9754-docker-setup" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-users"></i><span>Community</span><span class="ripple-container"></span></a></span>
                                    <div>
                                        <span class="wpb_button align_left"><a href="https://github.com/MediaBrowser/Wiki/wiki/Docker-Getting-Started" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-book"></i><span>Wiki</span><span class="ripple-container"></span></a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
