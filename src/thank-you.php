...
<body class="page page-id-4948 page-template-default l-body us-theme_zephyr_1-6 wpb-js-composer js-comp-ver-4.5.2 vc_responsive hasGoogleVoiceExt">
    <!-- CANVAS -->
        ...
        <div class="l-main">
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>Thank You</h1>
                        <!-- breadcrums -->
                        <div class="g-breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#"><span typeof="v:Breadcrumb"><a class="g-breadcrumbs-item" rel="v:url" property="v:title" href="index.html">Home</a></span> <span class="g-breadcrumbs-separator"><i class="mdfi_navigation_chevron_right"></i></span> <span class="g-breadcrumbs-item">Thank You</span></div>
                    </div>
                </div>
            </div>
            <div class="l-submain wpb_row">
                <div class="l-submain-h g-html i-cf">
                    ...
                    <p>You will receive your Emby Premiere key via email shortly. If you used PayPal, it will be sent to the primary email on that account. Otherwise, it will be sent to the email you provided at check out. Thank you and enjoy your media.</p>

                    <h3 style="margin-top:0;padding-top:0;">How to Activate</h3>
                    <p>
                        Copy and paste your Emby Premiere key into the field in the Emby Server dashboard under <strong>Emby Premiere</strong> and start enjoying all the additional benefits that come with Emby Premiere.
                    </p>
                    <img src="resources/premiereactivate1.png" />
                </div>
            </div>
        </div>
        <!-- /MAIN -->
    ...
    <!-- Cached page generated by WP-Super-Cache on 2016-01-03 01:55:25 -->
    <!-- Compression = gzip -->
</body>
</html>