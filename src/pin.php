                                ...
                                <div class="widget widget_text">
                                    <div class="textwidget">
                                        <div style="text-align: center;">
                                            <form id="confirmForm" style="margin: 0 auto; width: 100%; max-width: 400px;" target="_blank">
                                                <div class="notloggedin" style="">
                                                    <div style="text-align: left;">Emby username/email:</div>
                                                    <p>			<input id="username" style="width: 100%;" type="text" class="not-empty"></p>
                                                    <div style="text-align: left; margin-top: 10px;">Password:</div>
                                                    <p>			<input id="pw" style="width: 100%;" type="password" class="not-empty"></p>
                                                </div>
                                                <div class="loggedin" style="display: none;">
                                                    <p>			<img id="userimage" style="height: 100px;" src="resources/mb_logo_lt_pad.png" alt=""></p>
                                                    <h3>Hello <span id="loggedinuser"></span></h3>
                                                    <p>			<small><a id="notyou" class="notimplemented" href="#" target="_blank">Not you?</a></small></p>
                                                </div>
                                                <div>
                                                    <label for="pin" style="display:block;text-align:left;">Pin:</label><input id="pin" style="width: 100%;" required="" type="text">
                                                </div>
                                                <p>
                                                    <button class="g-btn color_primary type_raised size_big" type="submit" style="display:block;margin-top:30px;width:100%;">Submit<span class="ripple-container"></span></button><br>
                                        ...
                                        <p>
                                            ...
                                            <script src="resources/embyconnectpin.js"></script>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="full-width">
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h2 style="text-align: center;margin-top:-60px;">New Users</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- Row Backgrounds --><div class="upb_no_bg" data-fadeout="" data-fadeout-percentage="" data-parallax-content="" data-parallax-content-sense="" data-row-effect-mobile-disable="true" data-img-parallax-mobile-disable="true" data-rtl="false" data-custom-vc-row="" data-vc="4.5.2" data-theme-support=""></div><div class="g-cols wpb_row offset_wide">
                        <div class="full-width">
                            <span class="wpb_button align_center"><a href="https://emby.media/community/index.php?app=core&amp;module=global&amp;section=register" target="_blank" class="g-btn color_primary type_raised size_big"><i class="fa fa-edit"></i><span>Sign Up</span><span class="ripple-container"></span></a></span>
                        </div>
