                        ...
                        <div class="two-thirds">
                                ...
                                <div class="wpb_wrapper">
                                    ...
                                    <div style="margin:0 auto;max-width:450px;">
                                        ...
                                        <p>
                                            ...
                                            Download <a class="lnkPackageDownload" data-filename="embyserver-osx-x64-{version}.zip" href="https://github.com/MediaBrowser/Emby/releases/download/3.2.50.0/embyserver-osx-x64-3.2.50.0.zip" onclick="ga('send', 'event', 'Download Links', 'Downloaded', 'MacRelease');">Emby Server for MacOS</a>.
                                        </p>
                                        <p>
                                            <strong>Drag to Applications Folder</strong><br>
                                            After the download has completed, use Finder to drag EmbyServer from your Downloads folder to your Applications folder.
                                            <img src="server/mac1.png" />
                                        </p>
                                        <p>
                                            <strong>Start Emby Server</strong><br>
                                            Start Emby Server from your Applications menu like any other Application.
                                            <img src="server/mac2.png" />
                                            <br />If you're unable to start due to a message about unidentified developer, start Emby Server by clicking the settings icon, then Open.
                                            <img src="server/mac3.png" />
                                        </p>
                                        <p>
                                            <strong>Complete the Emby Server Setup Wizard</strong><br>
                                            Open your web browser and visit http://localhost:8096
                                        </p>
                                        <div style="margin-top:2em;color:gray;">Note: Installing into MacOS Applications is necessary due to Apple Gatekeeper path randomization, which allows the app to run in a confined environment.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h4>Resources</h4>
                                    <span class="wpb_button align_left"><a href="https://emby.media/community/index.php?/forum/117-osx" target="_blank" class="g-btn color_primary type_raised"><i class="fa fa-users"></i><span>Community</span><span class="ripple-container"></span></a></span>
                                    <div>
