...
<head itemscope itemtype="http://schema.org/Article">
    ...
    <meta charset="UTF-8">
    <title>Emby for Sony PlayStation 3 PS3- Emby</title>
    <meta name="description" content="Emby for Sony PlayStation 3 PS3 - Organize and stream your personal videos, music, photos and Live TV to any device.">
    {SOCIALNETWORKS}
            ...
            <div class="l-submain for_pagehead color_alternate size_large" style="padding-top: 140px;">
                <div class="l-submain-h g-html i-cf">
                    <div class="w-pagehead">
                        <h1>It Only Does Everything</h1>
                        <p>Emby for Sony PlayStation 3 PS3</p>								<div class="w-pagehead-nav">
                ...
                <div class="l-submain-h g-html i-cf">
                    <div class="g-cols wpb_row offset_wide">
                        <div class="two-thirds">
                            <div id="gallery_242308" class="w-gallery columns_2 type_masonry with_indents animate_revealgrid">

                                <div class="w-gallery-tnails" style="position: relative; height: 1031px;">
                                    <a class="w-gallery-tnail order_1" href="resources/ps3dlna1.jpg" title="1" style="opacity: 1; position: absolute; left: 0px; top: 0px;">
                                        <img width="600" height="316" src="resources/ps3dlna1.jpg" class="w-gallery-tnail-img" alt="1">
                                        <span class="w-gallery-tnail-title"></span>
                                    </a>
                                    <a class="w-gallery-tnail order_2" href="resources/ps3dlna1.jpg" title="2" style="opacity: 1; position: absolute; left: 370px; top: 0px;">
                                        <img width="600" height="316" src="resources/ps3dlna2.jpg" class="w-gallery-tnail-img" alt="2">
                                        <span class="w-gallery-tnail-title"></span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="wpb_text_column ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h2>Setup</h2>
                                    <p>Emby supports PS3 via PS3 Dlna features.</p>
                                    <p>Your PS3 will automatically detect your Emby Server and display it in the main menu for easy browsing and playback of content.</p>
                                </div>
                            </div>
                        </div>
